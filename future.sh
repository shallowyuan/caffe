...
BRANCHES="origin/accum-grad origin/share-blobs-over-nets origin/pythonlayer-parameter origin/python-gradient-checker-accum origin/python-gpu origin/python-gil origin/fix-autotop-python origin/bilinear-upsampling-filler origin/future-misc"
